...
## How a New Medicine Is Invented
...
## How a Generic Is Made

When the patent on a medicine expires, any company may produce its own version. That version is a **generic**: the same active ingredient, the same strength, the same dosage form.

A generic does not repeat the nine stages. The target was found, the molecule was optimised and the efficacy was proven years ago by the company that invented it. Repeating that work would be pointless, and in the case of Phase 3, unethical — you cannot give patients a placebo to prove again something already known.

### What is done instead

**Formulation development.** The active ingredient is known; the tablet around it is not. The generic company develops its own formulation — which binder, which coating, what hardness, how quickly it dissolves — and must manufacture it consistently, batch after batch.

**A bioequivalence study.** The only human study required. At least 24 healthy volunteers receive both the generic and the original, in a crossover design so that every person takes each one.

Blood samples measure two things: **Cmax**, the highest concentration the drug reaches, and **AUC**, the total exposure over time.

The generic passes if the 90 per cent confidence interval for both measures, compared against the original, falls between 80 and 125 per cent. That is the whole test. The question is not *does it work* — that is already established — but *does the body see the same thing*.

**An ANDA filing.** The evidence goes to the regulator as an Abbreviated New Drug Application. Abbreviated because the efficacy and safety sections are not repeated.

### The two routes compared

| | New medicine | Generic |
|---|---|---|
| Time | 10 to 15 years | 3 to 5 years |
| Cost | Around $2.6 billion | A few million dollars |
| Human studies | Phase 1, 2 and 3 | One bioequivalence study |
| Question being answered | Does this work, and is it better? | Does the body see the same thing? |
| Stages used | All nine | Stages 8 and 9, plus one small human study in place of 5 to 7 |

India is the largest supplier of generic medicines in the world: around 20 per cent of global supply by volume, 60,000 generic brands, and more than 60 per cent of all ANDA filings made to the US FDA.
...
| **Formulation Development** | 3, and all generic work | Turn an active ingredient into a tablet, capsule or injection that can be made consistently |
...
On the generic side, Discovery, Preclinical and Clinical Research barely exist as functions. The departments that dominate are Formulation Development, Manufacturing and QC, Regulatory Affairs, Quality Assurance, and Pharmacovigilance — which still applies in full, because a generic must be monitored after launch exactly like the original.

Those are the jobs most pharmacy graduates in India actually hold.

---

## Why So Few New Medicines Make It

These figures apply to the invention route. A generic faces none of this risk, which is exactly why the generic industry exists.
